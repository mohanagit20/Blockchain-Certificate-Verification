// Test script: demonstrates that only the contract owner
// can call storeCertificate() / revokeCertificate()
...
// Account #1 from your Hardhat node (NOT the owner/deployer)
